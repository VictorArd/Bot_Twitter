...
#Call api for the bot (Uncomment your choice)
#-------------------#
#Streaming
...
def live_likeandfollow
  #http://luanotes.com/posts/twitter-streaming-apis-with-ruby
  #---------------------------------------------------------#
